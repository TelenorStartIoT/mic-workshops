...
Open the serial monitor and type the following command to get the [`IMSI`] (https://no.wikipedia.org/wiki/International_mobile_subscriber_identity) and [`IMEI`] (https://no.wikipedia.org/wiki/IMEI) numbers.
