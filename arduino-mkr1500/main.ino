...
IPAddress MIC_IP(172, 16, 15, 14);   // No need to change this IP (StartIoT MIC instance)
...
// Send a formatted packed to the UDP port
...
void setup() {
  ...
  // TODO: ensure this method of checking is optimal
